...
abstract final class AppIcons {
  ...
  static const IconData arrowLeft = IconData(0xe058, fontFamily: 'Phosphor');
  static const IconData arrowRight = IconData(0xe06c, fontFamily: 'Phosphor');
  ...
  static const IconData buildings = IconData(0xe102, fontFamily: 'Phosphor');
  ...
  static const IconData calendarDots = IconData(0xe7b4, fontFamily: 'Phosphor');
  static const IconData calendarX = IconData(0xe10c, fontFamily: 'Phosphor');
  ...
  static const IconData cloudRain = IconData(0xe1b4, fontFamily: 'Phosphor');
  static const IconData cloudSlash = IconData(0xe1b6, fontFamily: 'Phosphor');
  ...
  static const IconData handPointing = IconData(0xe29a, fontFamily: 'Phosphor');
  static const IconData handSwipeRight =
      IconData(0xec92, fontFamily: 'Phosphor');
  static const IconData hourglass = IconData(0xe2b2, fontFamily: 'Phosphor');
  ...
  static const IconData trashSimple = IconData(0xe4a8, fontFamily: 'Phosphor');
  ...
  static const IconData wind = IconData(0xe5d2, fontFamily: 'Phosphor');
...
abstract final class AppIconsFill {
  static const IconData bicycle = IconData(0xe0d6, fontFamily: 'PhosphorFill');
